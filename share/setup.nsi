...
!define URL http://www.MACRON.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/MACRON.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\MACRON-qt.exe
...
OutFile MACRON-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/MACRON-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/MACRONd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\MACRON.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\MACRON-qt.exe
