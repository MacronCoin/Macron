...
unsigned int nTargetSpacing = 1 * 30; // MACRON - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // MACRON - time to elapse before new modifier is computed
...
const string strMessageMagic = "MACRON Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MACRON", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-asia-38971655";
        CTransaction txNew;
        txNew.nTime = 1487103714;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1487103714;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4596452;
        ...
        assert(block.hashMerkleRoot == uint256("0xce4f971b4bc982e4408184f22fb58949fee674dd16e40342af9a7f3eefd205e1"));
