...
QString tradingDialog::BuyMACRON(QString OrderType, double Quantity, double Rate){
...
QString tradingDialog::SellMACRON(QString OrderType, double Quantity, double Rate){
...
void tradingDialog::on_BuyMACRON_clicked()
{
    double Rate;
    double Quantity;
...
void tradingDialog::on_SellMACRONBTN_clicked()
{
    double Rate;
    double Quantity;
...
void tradingDialog::on_UnitsInputMACRON_textChanged(const QString &arg1)
{
     CalculateSellCostLabel(); //update cost
}
